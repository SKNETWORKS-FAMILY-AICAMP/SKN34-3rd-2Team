...
|:---:|---|
| 김기호 |  |
| 김대호 |PM으로써 프로젝트 진행에 있어서 조율을 하고 관리를 하는게 재밌었고, 실 사용자인 우리가 직접 불편한 점을 고쳐가면서 개선해나갈 수 있어서 원활하게 프로젝트를 마무리할 수 있었다. 매니저님과 강사님에게 직접 인터뷰를 통해 불편한 점을 찾고 더 완성도 높은 프로젝트로 나아갈 수 있었던 거 같아 뿌듯하다.  |
| 문성호 |  |
