...
export const roles = [
  {
    role: 'student',
    label: '학생',
    intro: '출석 확인부터 이력서, 학습, 마일리지, 학생 챗봇까지 수강 생활에 필요한 기능을 한곳에서 씁니다.',
    scenes: [
      {
        id: 'dashboard',
        route: '/',
      ...
      },
      {
        ...
        // capture.mjs가 「맞춤 공고 추천」을 누르고 결과가 나온 뒤 찍는다.
        action: 'recommend',
        title: 'AI 코치 · 맞춤 공고 추천',
        desc: '이력서 편집 화면 오른쪽 「맞춤 공고 추천」을 누르면 이력서의 기술·직무를 읽고 열린 공고에서 지원 조건과 근거를 비교해 추천합니다.',
        tips: [
          '「추천 근거 보기」로 이력서 문장과 공고 문장을 나란히 확인합니다.',
          '화면의 공고는 데모용 예시입니다.',
        ],
      },
      {
        ...
        route: '/resume/r-demo-1/edit',
        action: 'review',
        title: 'AI 코치 · 공고 맞춤 첨삭',
        desc: '추천 공고의 「공고 맞춤 첨삭」을 누르면 공고 요건에 맞춰 이력서 문장을 다듬은 수정안을 보여 줍니다. 「이 문장으로 바꾸기」로 반영하고 「되돌리기」로 되돌립니다.',
        tips: ['공고와 관계없이 문장만 다듬을 때는 「이력서 첨삭」을 누릅니다. 이력서에 없는 내용은 지어내지 않습니다.'],
      },
      {
        id: 'study-room',
        route: '/study-room',
      ...
      },
      {
        id: 'chatbot',
        route: '/',
        // capture.mjs가 챗봇을 열고 예시 질문을 보낸 뒤 찍는다.
        action: 'chatbot',
        title: '학생 챗봇',
        desc: '화면 오른쪽 아래 로봇 아이콘을 누르면 챗봇이 열립니다. LMS 정책·공지, 출결과 공가, 훈련장려금, 이전 기수 프로젝트를 물어볼 수 있습니다.',
        tips: [
          '「자주 묻는 질문」 버튼을 누르면 출결 기준·공가 사용 방법 같은 답을 바로 볼 수 있습니다.',
          '기수·단위기간·날짜 같은 조건을 함께 적으면 더 정확하게 답합니다.',
        ],
      },
      {
        id: 'my-page',
